            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="../auth_logouts/admin_logout.php">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4 p-3">
                                    <div class="card-body d-flex flex-column justify-content-center align-items-center ">
                                        ...
                                        \controllers\bookingController::countBooking();
                                        ?>
                                ...
                                <div class="card bg-secondary text-white mb-4 p-1">
                                    <div class="card-body">
                                        <div class="card-body d-flex flex-column justify-content-center align-items-center ">
                                            ...
                                            \controllers\studentController::countStudent();
                                            ?>
                                        </div>
                                    </div>
                                </div>
